...
def _markdown_to_html_document(markdown_text: str) -> str:
    ...
    return (
        ...
        "body{font-family:\"Helvetica Neue\",Helvetica,Arial,sans-serif;line-height:1.55;color:var(--cl-text);background:var(--cl-bg);min-height:100vh;padding:14px;}\n"
        ".container{max-width:1200px;margin:0 auto;background:var(--cl-surface);border:1px solid var(--cl-line);box-shadow:0 10px 28px rgba(17,17,17,0.08);overflow:hidden;}\n"
        ".utility-strip{display:flex;justify-content:space-between;gap:12px;align-items:center;background:var(--cl-primary);color:#E1F5EE;padding:9px 28px;font-size:0.72rem;letter-spacing:0.06em;text-transform:uppercase;}\n"
        ".utility-links{display:flex;gap:18px;flex-wrap:wrap;}\n"
        ".utility-links span{opacity:0.9;}\n"
        ".brand-row{display:flex;justify-content:space-between;align-items:center;padding:18px 28px;border-bottom:1px solid var(--cl-line);background:#fff;}\n"
        ".brand{font-family:Georgia,\"Times New Roman\",serif;font-size:1.2rem;letter-spacing:0.16em;color:var(--cl-black);text-transform:uppercase;white-space:nowrap;}\n"
        ".top-nav{display:flex;gap:18px;align-items:center;font-size:0.78rem;letter-spacing:0.06em;text-transform:uppercase;color:var(--cl-charcoal);}\n"
        ".top-nav a{color:inherit;text-decoration:none;border-bottom:1px solid transparent;transition:border-color 0.2s ease;}\n"
        ".top-nav a:hover{border-bottom-color:var(--cl-primary);}\n"
        "header{background:#fff;color:var(--cl-charcoal);padding:20px 28px 22px;border-bottom:1px solid var(--cl-line);}\n"
        ...
        "header p{color:var(--cl-muted);font-size:0.92rem;}\n"
        ".metadata{display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:12px;padding:16px 28px;background:#fafafa;border-bottom:1px solid var(--cl-line);}\n"
        ".meta-item{display:flex;justify-content:space-between;align-items:center;gap:10px;padding:12px;background:#fff;border:1px solid var(--cl-line);}\n"
        ".meta-label{font-weight:600;color:var(--cl-muted);font-size:0.72rem;text-transform:uppercase;letter-spacing:0.08em;}\n"
        ".meta-value{font-size:0.98rem;font-weight:700;color:var(--cl-charcoal);}\n"
        ".status-non-compliant,.status-denied{color:var(--cl-bad);}\n"
        ".status-compliant,.status-acceptable{color:var(--cl-good);}\n"
        ".content{padding:26px 28px 32px;}\n"
        "h2{font-family:Georgia,\"Times New Roman\",serif;font-size:1.5rem;color:var(--cl-charcoal);margin-top:30px;margin-bottom:14px;padding-bottom:8px;border-bottom:1px solid var(--cl-primary);}\n"
        "h2:first-child{margin-top:0;}\n"
        "h3{font-size:1rem;color:var(--cl-charcoal);margin-top:24px;margin-bottom:12px;padding:10px 12px;background:#f5f5f5;border-left:3px solid var(--cl-primary);display:flex;align-items:center;gap:10px;flex-wrap:wrap;}\n"
        ...
        "table{width:100%;border-collapse:collapse;margin:14px 0;border:1px solid var(--cl-line);}\n"
        "thead{background:var(--cl-primary);color:#fff;}\n"
        ...
        ".stat-box{padding:14px;background:#fff;text-align:center;border:1px solid var(--cl-line);border-top:3px solid var(--cl-primary);}\n"
        ".stat-box.acceptable{border-top-color:var(--cl-good);}\n"
        ".stat-box.denied{border-top-color:var(--cl-bad);}\n"
        ".stat-number{font-size:1.9rem;font-weight:700;color:var(--cl-charcoal);margin:4px 0;}\n"
        ".stat-box.acceptable .stat-number{color:var(--cl-good);}\n"
        ".stat-box.denied .stat-number{color:var(--cl-bad);}\n"
        ".stat-label{font-size:0.72rem;color:var(--cl-muted);text-transform:uppercase;letter-spacing:0.08em;font-weight:700;}\n"
        "footer{background:#f5f5f5;padding:14px 28px;text-align:center;color:#4f4f4f;font-size:0.8rem;border-top:1px solid var(--cl-line);}\n"
